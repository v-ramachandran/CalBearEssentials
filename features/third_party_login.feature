Feature: Login using Facebook or Twitter
...
Scenario: Successfully login with Facebook for the first time
  When I am a "Unregistered Student":
  And I follow "Login with Facebook"
  Then I should be on the "Registration" page

Scenario: Successfully login with Facebook (not for the first time)

  When I am a "Registered Student":
  And I follow "Login with Facebook"
